...
title: 'Welcome '
description: >-
  Welcome to the Notion Knowledge Base—your central resource for mastering the
  AI-powered workspace that unifies notes, docs, projects, and agents.
---
## Welcome
...
<Columns cols="3">
  <Card title="Platform overview" href="#" icon="book-open" horizontal="false">
    Learn how Notion organizes workspace content, apps, and connected tools in one place.
  </Card>

  <Card title="AI agents and automation" href="#" icon="zap" horizontal="false">
    See how agents handle repetitive work, answer questions, and help route tasks.
  </Card>

  <Card title="Knowledge base and wikis" href="#" icon="database" horizontal="false">
