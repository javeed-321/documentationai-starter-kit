...
To set up an App Group ID for the main application, from **TARGETS**, select your App Target, navigate to the **Signing and Capabilities** tab and perform the following:
...
<Image src="https://files.readme.io/fad705a-iOS_SDK_App_group_identifier.png" width="1920" height="1080" alt="" />

To set up an App Group ID for the Push Notification Extension Target, from **TARGETS**, select your App Target, navigate to the **Signing and Capabilities** tab and perform the changes as shown in the image below:

<Image src="https://files.readme.io/01c6356-Push_notification_extension_target.png" width="1920" height="1080" alt="" />
