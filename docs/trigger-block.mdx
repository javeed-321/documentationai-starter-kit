...
| **Every ___ minute(s)** | Yes      | The number of minutes between each trigger. Appears when **Schedule** is set to `Every X minutes`. Default value: `5`.                                                                                   |

<Image src="https://files.readme.io/2382865305d1a53ca33314fbe8fa0a3f1669b79bd360f0542f05d9da27a182f3-Screenshot_2026-04-15_at_11.13.32_AM.png" width="1920" height="1080" alt="" />
