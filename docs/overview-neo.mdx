...
<iframe src="https://player.vimeo.com/video/1058510121?h=bd2e53f905&title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479" width="100%" height="400" />
...
<iframe src="https://player.vimeo.com/video/1058510158?h=84bfeb56d7&title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479" width="100%" height="400" />
...
* **Core Packages and Utilities**: Access to core platform packages and common utilities.
...
* **Expose Private APIs**Enables you to use and also expose [private APIs](https://docs.capillarytech.com/reference/private-apis#/) as required.
