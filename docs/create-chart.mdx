...
3. Expand the **Chart Type** drop-down box and select **Normal** chart.
   ...
   <Image src="https://files.readme.io/abcc534-Normal_Chart_Creation.png" width="25%" height="1080" alt="" />
...
<Image src="https://files.readme.io/6d090ce-iPI3fd0DyW8Qo1DlOVY_Q36Nsvux5bZg6A.png" width="smart" height="1080" alt="" />
...
<Image src="https://files.readme.io/9aca74d-Change_view_type.png" width="1920" height="1080" alt="" />

<Image src="https://files.readme.io/6c139a0-Chart_View.png" width="1px" height="1080" alt="" />
...
8. If you want to rearrange the data trends and patterns in the chart, go to the **Table Options** and perform the following:
   ...
   1. Drag and drop the parameters in the **Rows** and **Columns** box. This provides an improved analysis of the selected KPIs and dimensions. For example, in the below image, on adding Reward type from row to column, the reward type is changed from row to column providing details associated with it.
      ...
      <Image src="https://files.readme.io/ae472a5-CreateNormalChart_PivotTable.gif" width="1920" height="1080" alt="" />
   2. Drag the KPIs up or down to **Prioritise** them.
   3. Click **Apply**.

   <Image src="https://files.readme.io/51ba5b6-Create_Normal_Chart_Prioritise.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/61389fbd49a597f3d9a007100aaeebdb86a52a0f746f7a47f8418103c0895ff8-Create_Chart_Badges_GIF.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/dc25205-Create_Migration_Chart.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/2376245-A8Td5NytSTZBIZ7kAcjXcK1fNsScWF-rEw.png" width="smart" height="1080" alt="" />
...
<Image src="https://files.readme.io/94f46f5-Migration_chart.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/6991b80-Report_Date_Range.png" width="46%" height="1080" alt="" />

<Image src="https://files.readme.io/d475aee-Funnel_Completion_Range.png" width="50%" height="1080" alt="" />

4. Click **Add Step**. Expand the event name drop-down list and select the event.

<Image src="https://files.readme.io/77025d7-Add_Step.png" width="100%" height="1080" alt="" />
...
<Image src="https://files.readme.io/b040397-Funnel_Chart.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/e8a2a99-Attrition_percent.png" width="50%" height="1080" alt="" />
