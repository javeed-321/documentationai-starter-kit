...
5. Click **Run Query**.\
   ...
   **Note**: You can explicitly add a limit clause to your query for the number of results, or the system might enforce a default limit if the number of results is more.
   ...
   <Image src="https://files.readme.io/56be905997d8603a3b23912904db7ed3da6f47c5bdf9bdf025a0757416eab388-runQuery.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/061bf6ce0fd99a377d403778b7a99b4150bf4c4791f91270049ccc6d735064ed-View_query_history.png" width="1920" height="1080" alt="" />
