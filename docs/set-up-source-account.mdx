...
1. Navigate to **Organisation settings > Omni Channel Settings > Channel Configurations** and click **MAPP_SDK**.

<Image src="https://files.readme.io/c6db242-Account_mobile_sdk.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/ceae3e0-Project_id.png" width="1920" height="1080" alt="" />

* **FCM Email** - Enter the FCM service account e-mail. This is available on the service account page in FCM.

<Image src="https://files.readme.io/96ebc58-Service_account_email.png" width="1920" height="1080" alt="" />
...
* **Add Deep links** - This is optional. The deep links added here will be available in Engage+ creatives for push notifications.\
  <Image src="https://files.readme.io/adddd6c-Deep_link.png" width="1920" height="1080" alt="" />

<Image src="https://files.readme.io/ce8cc75-iOS_and_Android.png" width="1920" height="1080" alt="" />
