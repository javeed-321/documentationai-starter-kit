...
1. Navigate to  **Logs and Metrics** > **Extensions Configurations** from the left pane of the Dev Console.
   ...
   <Image src="https://files.readme.io/b634beb3c47a93fb32c1514c6b45049b09abc05414e0035c4c8f7dcfe61eff40-secret_manager_dev_console.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/40969790f2885588d28c0afb8fdfa5c8bc4fd9f495d423afc73d7e3b1b9ed1d4-dev_console_add_config.gif" width="1920" height="1080" alt="Adding a config" />
...
<Image src="https://files.readme.io/43a80c0d97f23db1507fe578e9bf8b45e9765919a033a9c20e3239a7230b9689-dev_console_config_request.png" width="1920" height="1080" alt="Config Requests" />
...
4. Enter the existing config name in **Config Name** and the new value in **Config Value**.\
   ...
   <Image src="https://files.readme.io/9846634490f79f241caa6611c4598057935ded42757cd4bf28b7c601c6456d6d-Screenshot_2026-04-08_at_11.07.16_AM.png" width="1920" height="1080" alt="" />
5. Click **Confirm**.
...
1. From the DevConsole, navigate to the **Extensions Configurations** section.
   ...
   <Image src="https://files.readme.io/736cc9ff5a7ce610c60ac2f07cfe80b4616bd23e08281f28c3c12a2ead74ad6d-secret_manager_dev_console.png" width="1920" height="1080" alt="" />
2. From the dropdown in the top-right corner, choose the organization whose configurations you want to manage.
3. Click  **Config Requests**.\
   The configuration details are displayed.

   <Image src="https://files.readme.io/43a80c0d97f23db1507fe578e9bf8b45e9765919a033a9c20e3239a7230b9689-dev_console_config_request.png" width="1920" height="1080" alt="" />
4. In the configuration modal, click **Approve**.

   <Image src="https://files.readme.io/247808f1924fa7438042fcdb3063e07bc716b54c34561213fca7cfdef491c95a-approve_config_secret_manager.png" width="1920" height="1080" alt="" />
