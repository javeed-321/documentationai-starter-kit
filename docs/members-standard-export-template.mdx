...
This export template is based on the **[customer_summary](https://docs.capillarytech.com/docs/customer-summary-members-fact-table)** fact table. It contains details of members (loyalty and non-loyalty customers) and non-members based on the last updated date or event date (registration date).
