...
InTouch is Capillary's cloud-based platform that houses all product modules, including Organization Settings and Workbench. It is deployed across multiple regional clusters, and access is managed by role — not all users will have write access or access to every module. [Super Admins](https://docs.capillarytech.com/docs/new-user-management-overview) assign access based on role and scope.
...
<Image src="https://files.readme.io/0dbe388e91e7f304976e665478111d0344b009fba67e6a797c8d5f13344074d4-image.png" width="40%" height="1080" alt="" />
...
| Cluster | Login URL                                            |
| ------- | ---------------------------------------------------- |
| EU      | [https://eu.intouch.capillarytech.com/auth/login](https://eu.intouch.capillarytech.com/auth/login)    |
| SG      | [https://apac2.intouch.capillarytech.com/auth/login](https://apac2.intouch.capillarytech.com/auth/login) |
| India   | [https://intouch.capillary.co.in/auth/login](https://intouch.capillary.co.in/auth/login)         |

2. Click **Sign in with Google**.

<Image src="https://files.readme.io/124fff06a00c7b48b693d08cf874452061afe84fdd465115d8ec56e6aa235ab2-image.png" width="40%" height="1080" alt="" />

3. Enter your Capillary Google Workspace email address and click **Next**.
4. Enter your password and click **Next**.

<Image src="https://files.readme.io/639deba9be8e92000a2d358124c4b2961c0c2f773a8b8669dbdf760b1f5bbb8c-image.png" width="40%" height="1080" alt="" />
...
<Image src="https://files.readme.io/303472d-Workbench.png" width="100%" height="1080" alt="InTouch Workbench" />
...
#### Step 4: [Authenticate with SSO](Linhttps://docs.capillarytech.com/docs/accessing-capillary#authenticating-with-sso)
...
1. The Capillary Point of Contact (PoC) must send an email to the Capillary Access Team requesting SSO setup for the organization. The request must include the following details:
   ...
   * Organization email domain
     For example, if the email address is [abc@org.com](mailto:abc@org.com), the domain is org.com.
2. The Capillary Access Team will share the following information. This information must be provided to the organization’s PoC for configuring the IdP connection.
   ...
   * User profile attributes need to be passed as [SAML](https://www.cloudflare.com/en-gb/learning/access-management/what-is-saml/) assertion - email, first name, and last name. Email ID mandatory.
...
<Image src="https://files.readme.io/4611040-YcZE7z1u94dsCfdrLsaNl3MHQv3dLLoLXw.png" width="50%" height="1080" alt="" />
...
<Image src="https://files.readme.io/9f8ecf6b751c1131447de367300a601c1c4b92967fe7429257dd964f11fce68a-image.png" width="40%" height="1080" alt="" />
...
<Image src="https://files.readme.io/fc06d3a-JbFVF8IG9WAPHdhx0jG6_7ZWTVzYp65YmQ.png" width="40%" height="1080" alt="" />

3. On the Identity Provider page, enter your credentials (email address and password) and select **Sign in**.

<Image src="https://files.readme.io/58636b9-Dkn_2OjHNw_Om0sRCt_LIOk6jdl9UctSSQ.png" width="50%" height="1080" alt="" />
...
<Image src="https://files.readme.io/7cc238d2d617d4e97b6a06a6fed7e8daf820902fdde7553a3505c1f6ac155b56-MFA_config.png" width="80%" height="1080" alt="MFA configuration screen" />
