...
5. In the **Sort** field, specify how to sort the results. You can sort the results in ascending (represented by **1**) or descending order (represented by **-1**). To sort, include the field and the sort order in the syntax \{field: sorting_order\}. If sorting is not required, use `{}` as the default value.
   **Example usage:**
...
<Image src="https://files.readme.io/06721970dd8545e1983ac2ca6caf1c1a732f0cbdbb5b3225f2c0f163dbdba250-26.02.2025_16.57.38_REC_configuring_get_mongo.gif" width="85%" height="1080" alt="Configuring GET Mongo block" />
