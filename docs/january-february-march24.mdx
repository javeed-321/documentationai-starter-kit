...
Promotions 2.0 , an advanced version of Loyalty Promotions…..is a sleek addition to the Incentive Manager module, designed to hook your customers with gamified motivation and personalized experiences.

#### Diverse range of loyalty promotions for improved engagement

Brands can now run diverse promotions like hand-raiser in travel and hospitality, click to collect in ecommerce, choose your benefit, cross-sell products or create offers that can be unlocked by a specific target segment

* Customer has a choice to opt for one of the promotions; 1 free night OR 10% discount on F\ and B OR free airport transfers
* On a spend of 10,000 in a month, the customer unlocks 2X points on all incremental spends for the rest of the month.
* Customer plays scratch and win, and win 500 bonus points on purchase of denim in next transaction
...
### New tracking capabilities in Milestones and Streaks:

Milestones and Streaks are one of the most powerful gamification and behavior creation capabilities using which brands can greatly increase their user-retention and loyal customer base. Now, these modules have become much more powerful with the added new capabilities.
...
With the help of Streaks, brands can now induce continuous purchasing (or activity-doing) behavior in their customers using the principles of behavioral psychology. Brands now can implement use cases as per their requirement and get the desired outputs. For example, now brands can say:
...
* Walk 200k steps in a month for any 10 months in a year, and get a fitness badge and 10k points.
...
With this new capability, now brands can further gamify their end-user journey by awarding various kinds of reward currencies instead of just points. Brands can create different reward currencies like stars, stamps, boosts, etc.. as per their use cases and issue them to their customers along with points.
...
<Image src="https://files.readme.io/a0bb0a3-Screenshot_2024-04-19_at_4.11.14_PM.png" width="90%" height="1080" alt="" />
...
<Image src="https://files.readme.io/796591b-image1.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/8fefd1b-image1.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/89055c3-Screenshot_2024-03-27_at_12.14.40_PM.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/47ec2f9-image3.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/47e9942-image2.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/b154f01-image2.png" width="500px" height="1080" alt="" />
...
<Image src="https://files.readme.io/594484d-InApp.jpeg" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/ebd0fb3-Campaign_Sync.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/a5088ef-Recurring_message.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/d07f007-255a796-Skip_wait_.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/a81bc46-AB_Testing.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/dffd1e4-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/98681fe-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/c0be475-image.png" width="500px" height="1080" alt="" />
...
In recent quarters, we've focused on enhancing Customer Data Security by identifying vulnerabilities and implementing crucial security measures. Some of those enhancements being, placing limitations on downloads from Databricks and enabling masking of PII information in Analytics tables.
...
However, the user actions where such a maker checker flow was supported were selected and very standardized in nature. With the release of the new request workflow framework, we can now:
...
Certain actions on user profiles are very critical and brands sometimes want to gate-keep them from either getting abused or to ensure the sanctity of customer data.\
Here, people want a workflow to gate-keep it - wherein a user would raise a request and some other users would approve it in a similar scenario.
...
Apart from this, we can now create and support more customized and complex use cases like:

* Multi-approval workflows
* Extension/complex logic-based validations
* Organization unit-specific maker checkers are now supported

**Caveat:** While customization features can now be supported on the product; it would still need to be created and set up by your service delivery team and involve relevant costs.
