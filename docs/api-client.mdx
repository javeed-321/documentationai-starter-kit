...
<Image src="https://files.readme.io/17c930d-Authentication.png" width="15%" height="1080" alt="" />

3. Click the **API client** tab.
4. Click Register.

<Image src="https://files.readme.io/b458f7d-register.png" width="1920" height="1080" alt="" />

5. In **Client name**, enter a name for the client.

<Image src="https://files.readme.io/f690f6e-Access.png" width="40%" height="1080" alt="" />

6. In the **Description**, enter a short description of the client.

7. Select the **Allow access to sensitive information** checkbox if you want to allow the API client to access unmasked PSI data. If you leave this option disabled, API responses return PSI fields as masked when you use the OAuth token. This behaviour applies only [https://docs.capillarytech.com/docs/introduction-datamasking#enabling-data-masking](https://docs.capillarytech.com/docs/introduction-datamasking#enabling-data-masking).

   <Image src="https://files.readme.io/6a0d8a2f1245d43a3baddeb32f1b7e884f07c3c1e038d955fcc8d54f1cbe0c22-image.png" width="35%" height="1080" alt="" />
...
<Image src="https://files.readme.io/06e18e0-60_min_limit.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/40e1b46-Token_30_days.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/ac9b19c-Select_access_group.png" width="40%" height="1080" alt="" />

11. Click **Next**. The Client key and Client secret are generated for the client.

<Image src="https://files.readme.io/11dd3fd-clie.png" width="40%" height="1080" alt="" />
...
<Image src="https://files.readme.io/825679d-clienttt.png" width="1920" height="1080" alt="" />

<Image src="https://files.readme.io/916d8e7-demo.png" width="1920" height="1080" alt="" />
