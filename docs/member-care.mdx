...
<Image src="https://files.readme.io/ed6d8d3-Search_customer.gif" width="1920" height="1080" alt="" />

By default, if enabled, when you open Member Care, the application opens the new Member Care UI.

<Image src="https://files.readme.io/dfe3269-1.gif" width="smart" height="1080" alt="" />

## Switching to the new UI

To switch to the new Member Care from the old UI **CSV** page, click **Open new Member Care**.

<Image src="https://files.readme.io/e4c005a-Switch_to_new_UI.png" width="1920" height="1080" alt="" />

Also, from the old UI, if you click **Customer Search** the customer search opens in the new UI.

<Image src="https://files.readme.io/7bf007a-3.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/6c42392-Switch_to_Old_member_care.gif" width="1920" height="1080" alt="" />
...
For example, [https://eucrm.cc.capillarytech.com/memberCare/search/Customer?id=172076358 and oldFlow=true](https://eucrm.cc.capillarytech.com/memberCare/search/Customer?id=172076358&oldFlow=true)
