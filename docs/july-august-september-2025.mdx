...
[https://docs.capillarytech.com/docs/vulcan-application-extension-in-member-care#/](https://docs.capillarytech.com/docs/vulcan-application-extension-in-member-care#/)
...
<Image src="https://files.readme.io/09002de767ba7d045df072b1c1e7a23f19017c2f89d6e1c59414511ac32d8e21-image_4.png" width="40%" height="1080" alt="" />
...
<Image src="https://files.readme.io/c089643936b26a153b643822c5a7a51fd14ef5c6ff1ae602f0bf416c157d4177-Screenshot_2025-08-01_at_6.27.48_PM.png" width="45%" height="1080" alt="" />
...
<Image src="https://files.readme.io/4cc6de4a429b80f779409156caf26f1c7ced9ea620b0677754e1296accb41f03-Screenshot_2025-08-01_at_6.30.58_PM.png" width="45%" height="1080" alt="" />
...
The reward catalog APIs have been enhanced to ensure that all time-based evaluations within the Rewards Catalog align with the organization's time zone.  To achieve this, a [new configuration ](https://docs.capillarytech.com/reference/timezone-management#/)has been introduced that, when enabled, standardises the time zone according to the organization's settings in the reward catalog APIs.

### Filter rewards by customer’s actual purchase date

You can now [filter user rewards based on the event date](https://docs.capillarytech.com/reference/get-rewards-for-user-new-api#/), the actual date and time a customer performed an activity, rather than only the system’s processing date.

### Change upcoming rewards to ended reward before launch

You can now  end an upcoming reward before it goes live. By s[etting the reward’s end date to a date earlier than its start date](https://docs.capillarytech.com/reference/put-update-reward#/), the reward is marked as ended. This ensures that only valid and intended rewards are ever available to customers.

### Transaction-based coupon filtering

The [API used to retrieve available coupons](https://docs.capillarytech.com/reference/get-customer-coupons-basic#/) for a customer has been updated to support filtering coupons based on the transaction number. This helps in scenarios such as a return transaction where you want to cancel the coupons provided as part of the transaction.

### Exact coupon expiry time in v2 API

The v2 [Get Customer Coupon API ](https://docs.capillarytech.com/reference/get-customer-coupons-basic#/)now includes a new field, validTillDateTime, that shows the exact expiry timestamp for a coupon.
...
Promotions can now be created and updated directly through the exposed [promotion APIs](https://docs.capillarytech.com/reference/create-cart-promotion-api#/). This makes it easier to sync offers with external systems, automate workflows, and launch promotions faster.
...
[https://docs.capillarytech.com/docs/connect-to-source#/ssh-authentication](https://docs.capillarytech.com/docs/connect-to-source#/ssh-authentication)
