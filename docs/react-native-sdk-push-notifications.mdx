...
2. In your Xcode project settings for your application target, add the following capabilities under Signing and Capabilities:
   * Push Notification
...
1. Go to your project settings in Xcode and add a new target and select Notification Service Extension from the available templates. This adds a Notification Service Extension to your project.
   ...
   <Image src="https://files.readme.io/425ac7aca18db38c8f1fc3e5739a15d70f8b50b44cc27c7b1954ab71fbf49fa5-image.png" width="80%" height="1080" alt="" />
...
<Image src="https://files.readme.io/4e6b398bdee413ff26531398ea311e4577c6edceb10649a457b6c64286fde377-image.png" width="80%" height="1080" alt="" />

3. Select the language as `Objective-C`if your `AppDelegate` is Objective-C and `Swift` if your AppDelegate is Swift.

   <Image src="https://files.readme.io/02b47dde83d3360d459dac5d69b941cdda4ef07a490b2bf87ba14d5f7ae20c25-image.png" width="80%" height="1080" alt="" />
