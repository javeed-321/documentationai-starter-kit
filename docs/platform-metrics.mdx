...
<Image src="https://files.readme.io/d0406da50ec07345aa680e68fcd456340ef17d5423180a69811f70e72eed448d-platform_metrics.gif" width="1920" height="1080" alt="" />
...
1. From the Platform Metrics page, select the date range from the drop-down and click **Apply**.\
   **Note**: The maximum custom date range you can select is 30 days.
   ...
   <Image src="https://files.readme.io/fa76ea77da107de96f0a3386726862ed650e76219a4fe10d10ab3c07116fdedf-image.png" width="1920" height="1080" alt="" />
2. Select the product from the `Select Product` drop-down.

   <Image src="https://files.readme.io/87743b6458689fd27bcebed1f567fe64d0ae8695cce7a046cc119072037230ec-image.png" width="1920" height="1080" alt="" />
3. Select the dashboard from the `Select DasbBoard` drop-down.

<Image src="https://files.readme.io/155fe3d8e1fb199d6a1856643f5e715b28e0bf405e1b10b2cb51aff1f9f01ab4-image.png" width="1920" height="1080" alt="" />

4. (Optional)Filter your search by selecting specific API endpoints for the chosen products.

<Image src="https://files.readme.io/f60e67a01b7641cc5fd6556775065e160cc61dd2f97acf4bdef10449ff8cd0bd-image.png" width="1920" height="1080" alt="" />
...
| Field Name | Description |
| --- | --- |
| Status code | The HTTP status code of the API execution. The different statuses are: 2xx - Success 4xx - Client Errors 5xx - Server Errors |
...
| Field Name | Description |
| --- | --- |
| Status code | The HTTP status code of the Intouch API execution. The different statuses are: 2xx - Success 4xx - Client Errors 5xx - Server Errors |
...
4. Define the configuration for each chart in a JavaScript array. Specify the following:
   ...
   * (Optional) Metadata and Customization (Optional) – Configure additional properties:
     * Format timestamps.
