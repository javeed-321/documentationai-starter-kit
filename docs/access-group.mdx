...
<Image src="https://files.readme.io/7224e20-Access_control.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/2c25ad3-Resource.png" width="55%" height="1080" alt="" />
...
4. In the **Group permission**, select the  and set the permission for **Data API** and **Config API** as follows:
   ...
   * **Write**: Access to POST API endpoints. For example, an access group with Write access to Coupon resource will have access to all Coupon POST API endpoints.
     ...
     <Image src="https://files.readme.io/b8e5bcb-Search_Resource.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/8f7fec4-Create_Access_Group.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/19c49e7-Change_default_group.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/80fec33-Number_of_store.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/4ff870b-Search_and_View.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/48dd079-Edit_access_group.gif" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/af06d18-Deactivate.gif" width="1920" height="1080" alt="" />
