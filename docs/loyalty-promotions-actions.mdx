...
<Image src="/diagrams/loyalty-promotions-actions-diagram.svg" width="1920" height="1080" alt="Diagram" />
...
**Requirement:** A retail brand wants to reward customers with loyalty points for every successful purchase. The brand also wants to apply proration, and control expiry rules and define the rounding strategy for the points issued.
...
<Image src="https://files.readme.io/8a1d6352a0f2a4e05fb61f00280cec0106ba0f117c17a4adece379d41798b4f9-image.png" width="1920" height="1080" alt="" />
...
<Callout kind="info" title="All proration types listed above, including Proportional to Value with Line Item Quantity as the base value, are supported for both points and alternate currencies.">
...
<Image src="https://files.readme.io/ec7b29b2d50e2d8954504b7c60488dc1bf1066b3d8667b9522b8bcdb9521a0ef-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/547b5560a703efb44fd37e18369b421198854403c4c9167f59fef6eeffdf5449-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/767459a653c56da47e6752e31614905df5410339ddbbb173bf38d7dd7b047239-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/6d7858fe549613eb2d33ffccf67581bcd8d08b67aefb3b9361bde60d7c10fb85-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/d2937486b5c39e4e46dcde1af529341d82d7a89b215abf37b6dfb4746e74e0e4-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/92a281af8a02f8583c6d78a052ab4376095c9c8e7fe379b59dc9ea1c8b4e5ef7-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/7ae7689f255d50cf270a9235222a1f522cd0ed6c37005e107fefbc0e888f5fae-image.png" width="1920" height="1080" alt="" />
...
📘The Manage Tier action is supported for all promotion types, including promotions triggered by a Behavioural Event member action.
...
**Requirement:** A retail brand wants to automatically upgrade customers to a higher loyalty tier when they meet a defined criterion. The brand also wants to control tier expiry and customer communication.
...
<Image src="https://files.readme.io/b586b28d0f3cad84b43d48f8ace3b4b39a505e101490f7553d746e76fe5d4940-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/33c27f4eb3a012e84474dfd57c35fae34ffd9fdb0a8523b7b822c955b08d69d9-image.png" width="1920" height="1080" alt="" />
...
1. Toggle Communication to ON to notify the customer when the badge is issued, and select the communication channels.
2. Select Claim to save the action.
...
<Image src="https://files.readme.io/798bcb93eedd29fe1e1e696cd05c962837290665a781233ec5ebdf7c7e605f4f-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/bcea0163cf18ecfdb96920364296a2b16187934c7e1ff74b10928a1762df1678-image.png" width="1920" height="1080" alt="" />
...
3. (Optional) If you selected a line item-based value in the Based on dropdown, select how coupons should be calculated under Issue coupon based on.
4. (Optional) Select + Include/exclude transactions to filter which transactions are included in the calculation.
5. (Optional) Expand Additional settings and select the Fixed amount rounding strategy.
6. (Optional) In the Notes field, enter any additional comments about this coupon issuance. Max 250 characters.
7. (Optional) In the Reason field, enter the business justification for issuing the coupon, for example, goodwill gesture, promotional reward, or complaint resolution. Max 250 characters.
8. Toggle Communication to ON to notify the customer when the coupon is issued, and select the communication channels.
9. Select Save to complete the configuration.

<Image src="https://files.readme.io/f6d782e53cd06eb863685cc33e9a26b181eefdbcf0fd2e1dd8575a3fd0232f50-image.png" width="1920" height="1080" alt="" />
...
**Requirement:** A retail brand wants to reward customers with a predefined reward when they make a purchase. The brand wants to issue rewards as a fixed quantity based on the customers' tier and also notify the customer.
...
<Image src="https://files.readme.io/3f634b095c2d6dc2f577dae742c1aafa8ad7f6530a47deadf465d8328749d4da-image.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/6cb0a19db1f9d1050e72eb3a0d6bbb13546704652f1f8435c76b2e3009327f13-image.png" width="1920" height="1080" alt="" />
...
1. In the Number of rewards to be issued dropdown, select the issual criterion. The following issue criteria are available:
...
1. Toggle Same for all tiers to ON to issue a fixed quantity of rewards for customers across all tiers. Toggle Same for all tiers to OFF to issue different quantities of rewards for customers across different tiers. If you create a new tier for the loyalty program, you must also reconfigure the values for the promotion.
2. Enter the quantity of rewards to issue.
3. (Optional) If you selected a line item-based value in the Based on dropdown, select how rewards should be calculated under Issue reward based on.
4. (Optional) Select + Include/exclude transactions to filter which transactions are included in the calculation.
5. (Optional) Expand Additional settings and select the Fixed amount rounding strategy.
6. Toggle Communication to ON to notify the customer when the reward is issued, and select the communication channels.
7. Select Save to complete the configuration.

<Image src="https://files.readme.io/1a212110339714dd622cdb4ccc976e6fb54e06d38cd60e147d60913456e12a3e-image.png" width="1920" height="1080" alt="" />
...
📘If an organization has WhatsApp, Zalo, and LINE sender IDs configured on Engage+, the same will be available on Loyalty+. To configure a new sender ID, refer to Configuring WhatsApp Sender Details or raise a JIRA ticket to the gateways team. Refer to the Creatives documentation to create templates for WhatsApp and Zalo.Reporting is available through Databricks to track communications sent through loyalty promotions, providing visibility into message delivery and customer engagement specifically for messages sent via the Send Communication action.
...
3. Configure the message content. You can use labels to personalize the message content.
...
2. In the Partner program dropdown, select the specific subscription program to enrol the customer in. Note: Only active subscription programs linked to the current loyalty program will be available for selection.
...
1. (Optional) Enable Communication to notify customers of their enrolment through supported channels.
2. Select Save to complete the configuration.
