...
* **Behavioral events** - This refers to user activities that can be tracked and used to trigger or personalize journeys. These events include both **standard events** and **custom events**.
  ...
  2. **Custom events** can be created to track specific user actions that are not covered by standard events. For steps to create custom events, refer to the [https://docs.capillarytech.com/docs/setup-test-behavioral-events#/add--map-custom-event](https://docs.capillarytech.com/docs/setup-test-behavioral-events#/add--map-custom-event) documentation.
...
<Image src="https://files.readme.io/9ecc3d370d7b016613a4eb2c17428ff4c1688f287fa1a66a75a963ef21ac6d54-gihyi.gif" width="100%" height="1080" alt="" />
...
5. From the list of available behavioral events, you can either select from the existing custom events (if they meet your requirements) or create your own [https://docs.capillarytech.com/docs/setup-test-behavioral-events#/add--map-custom-event](https://docs.capillarytech.com/docs/setup-test-behavioral-events#/add--map-custom-event).

<Image src="https://files.readme.io/0b48d0dae4fa6438732e5176a98e3144a65f937273e12f3832490401d8bf96b5-Untitled_design_3.gif" width="1920" height="1080" alt="" />
...
For behavioral event type you can define conditions using three key attributes. The available attribute categories are **Customer Profile**, **Store Profile** and **Behavioral Event Profile**. The **[https://docs.capillarytech.com/docs/configure-events-and-conditions#/transactional-event](https://docs.capillarytech.com/docs/configure-events-and-conditions#/transactional-event)** and **[https://docs.capillarytech.com/docs/configure-events-and-conditions#/transactional-event](https://docs.capillarytech.com/docs/configure-events-and-conditions#/transactional-event)** attributes are the same as those used for transactional events. However, for the [**Behavioral Event Profile**](https://docs.capillarytech.com/docs/setup-test-behavioral-events#/), you need to configure the attributes based on your specific requirements.
...
<Image src="https://files.readme.io/602d3889d67b96a04476a5671a7c2219c852ceb159cbbe1ac957343ac5a9d830-regex_gifs.gif" width="90%" height="1080" alt="" />
...
<Image src="https://files.readme.io/88e25bf85cf077093f84d75b4d3e9c2e6d3c5111b2346e2d9f4d5cb50acf1e11-regex1gif.gif" width="90%" height="1080" alt="" />
