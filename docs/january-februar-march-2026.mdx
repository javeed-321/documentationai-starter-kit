---
title: January-February-March 2026
---
...
**Documentation link**: [https://docs.capillarytech.com/docs/configure-email#creating-an-email-using-the-html-editor](https://docs.capillarytech.com/docs/configure-email#creating-an-email-using-the-html-editor)
...
**Documentation**: [https://docs.capillarytech.com/docs/test-and-preview-across-engagement-channels](https://docs.capillarytech.com/docs/test-and-preview-across-engagement-channels)
...
**Documentation link**: [https://docs.capillarytech.com/docs/labels](https://docs.capillarytech.com/docs/labels)

**Updated Liquid Expression Validation Workflow in Creatives**

Liquid expressions in SMS, Push Notification, In-App, and Email templates are no longer strictly validated during template creation in the Creatives section. Users can save templates with any Liquid expressions and use Test and Preview without immediate validation errors. However, invalid or unsupported Liquid expressions will trigger errors during campaign creation, preventing the selection or use of such templates.

**Documentation**:  [https://docs.capillarytech.com/docs/add-dynamic-content-using-liquid](https://docs.capillarytech.com/docs/add-dynamic-content-using-liquid)
...
Documentation: [https://docs.capillarytech.com/docs/data-import-new](https://docs.capillarytech.com/docs/data-import-new)
...
**Documentation**: [https://docs.capillarytech.com/docs/connect-plus](https://docs.capillarytech.com/docs/connect-plus)
...
For more details, refer to [Get coupon details](https://docs.capillarytech.com/reference/get-coupon-details)
...
For more details, refer to [Get all cart promotion details](https://docs.capillarytech.com/reference/get_all_cart_promotion_details)_
