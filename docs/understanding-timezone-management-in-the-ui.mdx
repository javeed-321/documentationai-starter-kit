---
title: Understanding Timezone Management in the UI
---
...
* Organizations with the CONF_ORG_DISABLE_MACHINE_TIME_CONV configuration enabled may experience billing time inconsistencies in the Membercare UI. This configuration is deprecated and should no longer be used.
...
**Promotions (New UI)** supports timezone selection at creation. A dropdown lists timezones in IANA format (for example, `Asia/Shanghai`, `Europe/London`). Available timezones are populated from the [https://docs.capillarytech.com/docs/org-management#create-or-modify-organization-profile-information](https://docs.capillarytech.com/docs/org-management#create-or-modify-organization-profile-information). The selected timezone defines the local time context in which the promotion is scheduled.

<Image src="https://files.readme.io/35a9377195585f953ed9b8dd112059ab29961d27a2831966a277e30aa8246874-gif_16.gif" width="75%" height="1080" alt="" />
...
Member Care displays dates and times in the organization timezone by default. Unlike other modules, support agents can also select a different timezone using the timezone dropdown during a session. Available timezones are populated from the [https://docs.capillarytech.com/docs/org-management#set-org-timezone-tab](https://docs.capillarytech.com/docs/org-management#set-org-timezone-tab).

This allows support teams to view timestamps in the customer's local context when investigating a query.

<Image src="https://files.readme.io/e7fb622fc3b924582a5135ccde117a9d070affb57b902098c973a5d08db48e1f-gifyy_1.gif" width="75%" height="1080" alt="" />
