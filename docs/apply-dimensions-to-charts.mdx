...
<Image src="https://files.readme.io/5f53638-Primary_Dimension_Gif.gif" width="50%" height="1080" alt="" />

2. To add more dimensions, Click **+/- attribute**.

<Image src="https://files.readme.io/1ae0727-Applying_dimension.png" width="1920" height="1080" alt="" />

For example, to see a month-wise report of the current year, click **Date** to expand and select **Month**.

<Image src="https://files.readme.io/618e278-date_attribute.png" width="50%" height="1080" alt="" />

Following is the tabular format (for better understanding) of the zone-wise, month-wise reports.

<Image src="https://files.readme.io/c21c29c-Month_wise.png" width="55%" height="1080" alt="" />

You can see all applied dimensions below the chart header.

<Image src="https://files.readme.io/c2641ba-Zone_and_Month.png" width="60%" height="1080" alt="" />
