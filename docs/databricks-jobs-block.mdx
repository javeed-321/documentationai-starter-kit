...
| **dataBricksUrl** | Yes | The Databricks API URL used to trigger and monitor the job. For example, `https://capillary-scrum.cloud.databricks.com/api/2.1/jobs`. |

<Image src="https://files.readme.io/429301c34bd54599896985499d6a00a5a7302657f2f37cd8d2d9c971ddc211ac-Screenshot_2026-04-21_at_3.38.35_PM.png" width="1920" height="1080" alt="" />
