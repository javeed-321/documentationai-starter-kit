...
3. In the **Block Name** field, enter a name for the block.\
   Block names cannot contain spaces or special characters, except for underscores (_). Use camelCase or snake_case formatting.
...
<Image src="https://files.readme.io/10ee2da0bc3272269f28e276120d3c1803f7d1d9502d5d3330fff41992fae529-24.03.2025_20.08.44_REC_Configuring_decrypt_block.gif" width="1920" height="1080" alt="Configuring the Decrypt block" />
