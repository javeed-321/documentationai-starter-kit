...
<Expandable title="Request Body">
  ...
  <ParamField body="action" param-type="string" required="false">
  </ParamField>
  <ParamField body="promotion" param-type="object" required="false">
  ...
  <ParamField body="customer" param-type="object" required="false">
    ...
    <ParamField body="identifierName" param-type="string" required="false">
    </ParamField>
    <ParamField body="identifierValue" param-type="integer" required="false">
    </ParamField>
