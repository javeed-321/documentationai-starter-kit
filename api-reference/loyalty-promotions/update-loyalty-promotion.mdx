...
<Expandable title="Request Headers" default-open="false">
  <ParamField header="Authorization" param-type="string" deprecated="false" show-location="true">
    Basic or OAuth authorization token. Example: `Basic <base64-encoded-credentials>`
  </ParamField>

  <ParamField header="Content-Type" param-type="string" deprecated="false" show-location="true">
    Must be `application/json`.
  </ParamField>
</Expandable>

<Expandable title="Path Parameters" default-open="false">
  <ParamField path="promotion_id" param-type="string" deprecated="false" show-location="true">
