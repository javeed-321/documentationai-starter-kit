...
<Tabs>
  <Tab title="DRAFT → PENDING_APPROVAL" icon="send">
    ```bash
  ...
  <Tab title="PENDING_APPROVAL → DRAFT" icon="undo">
    ```bash
  ...
  <Tab title="ACTIVE → PAUSED" icon="pause">
    ```bash
  ...
  <Tab title="ACTIVE → STOPPED" icon="square">
    ```bash
        curl --location --request PUT 'https://eu.api.capillarytech.com/v3/requests/PROMOTION/{promotionId}/status?existingStatus=ACTIVE' \
        --header 'Content-Type: application/json' \
        --header 'Authorization: Basic <token>' \
  ...
  <Tab title="PAUSED → ACTIVE" icon="play">
    ```bash
  ...
  <Tab title="PAUSED → STOPPED" icon="x-circle">
    ```bash
        curl --location --request PUT 'https://eu.api.capillarytech.com/v3/requests/PROMOTION/{promotionId}/status?existingStatus=PAUSED' \
        --header 'Content-Type: application/json' \
        --header 'Authorization: Basic <token>' \
