...
<Expandable title="Path Parameters">
  <ParamField path="promotionId" param-type="string" required="true">
    The unique identifier of the promotion to update.
  </ParamField>
</Expandable>

<Expandable title="Query Parameters">
  <ParamField query="existingStatus" param-type="string enum" required="true">
...
<Expandable title="Request Body">
  <ParamField body="promotionStatus" param-type="string enum" required="true">
