...
<Expandable title="Path Parameters">
  <ParamField path="customerId" param-type="integer" required="true">
  </ParamField>
</Expandable>

<Expandable title="Query Parameters">
  <ParamField query="programId" param-type="integer" required="true">
  </ParamField>
  <ParamField query="promotionId" param-type="integer" required="true">
  </ParamField>
