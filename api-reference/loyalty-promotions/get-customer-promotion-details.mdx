...
<Expandable title="Path Parameters" default-open="false">
  <ParamField path="customerId" param-type="integer" required="true" deprecated="false" show-location="true" />
</Expandable>

<Expandable title="Query Parameters" default-open="false">
  <ParamField query="programId" param-type="integer" required="true" deprecated="false" show-location="true" />

  <ParamField query="promotionId" param-type="integer" required="true" deprecated="false" show-location="true" />
