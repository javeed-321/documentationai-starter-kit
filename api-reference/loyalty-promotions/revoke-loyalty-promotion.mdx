...
<Expandable title="Request Headers">
  ...
  <ParamField header="X-CAP-API-AUTH-ENTITY-ID" param-type="integer" required="false">
...
<Expandable title="Query Parameters">
  <ParamField query="revokeAllEnrollments" param-type="boolean" required="false">
  ...
  <ParamField query="revokeAllOptIns" param-type="boolean" required="false">
...
<Expandable title="Request Body">
  <ParamField body="requestId" param-type="string" required="false">
  ...
  <ParamField body="action" param-type="string enum" required="true">
    The revoke action to perform. Case-sensitive.
  </ParamField>
  <ParamField body="programId" param-type="integer" required="true">
  ...
  <ParamField body="promotion" param-type="object" required="true">
    ...
    <ParamField body="promotionId" param-type="integer" required="false">
      Numeric identifier of the promotion.
    </ParamField>
    <ParamField body="promotionIdentifier" param-type="string" required="false">
      UUID string identifier of the promotion.
    </ParamField>
    </Expandable>
  </ParamField>
  <ParamField body="customers" param-type="object[]" required="true">
    List of customers to revoke. Exactly 1 entry is supported in the current release.
    <Expandable title="customers properties">
    <ParamField body="identifierName" param-type="string enum" required="true">
      Customer identifier type.
    </ParamField>
    <ParamField body="identifierValue" param-type="string" required="true">
      Value for the customer identifier.
    </ParamField>
    <ParamField body="source" param-type="string enum" required="false">
      Source of the customer's registration.
    </ParamField>
    <ParamField body="enrollmentIds" param-type="integer[]" required="false">
      Enrollment IDs to revoke. Required for REVOKE_ENROLL unless revokeAllEnrollments=true. Max 10.
    </ParamField>
    <ParamField body="optInIds" param-type="integer[]" required="false">
      Opt-in IDs to revoke. Required for REVOKE_OPTIN unless revokeAllOptIns=true. Max 10.
    </ParamField>
    </Expandable>
  </ParamField>
  <ParamField body="optOutDate" param-type="string" required="false">
    ISO-8601 timestamp to retroactively stamp as the revoke date. Must not be in the future.
  </ParamField>
  <ParamField body="storeUnitId" param-type="integer" required="false">
  ...
  <ParamField body="sourceDetails" param-type="object" required="false">
    Audit attribution for the revoke operation.
    <Expandable title="sourceDetails properties">
    ...
    <ParamField body="sourceActivity" param-type="string" required="false">
      Activity tag from the calling system.
    </ParamField>
    <ParamField body="sourceMetadata" param-type="object" required="false">
      Free-form key-value audit metadata to associate with the revoke operation.
      <Expandable title="sourceMetadata properties">
      <ParamField body="revokedBy" param-type="integer" required="false">
