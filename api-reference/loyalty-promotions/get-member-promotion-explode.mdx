...
<Expandable title="Path Parameters">
  <ParamField path="memberId" param-type="integer" required="true">
  </ParamField>
  <ParamField path="promotionId" param-type="integer" required="true">
  </ParamField>
</Expandable>

<Expandable title="Query Parameters">
  <ParamField query="memberEnrollmentStatus" param-type="string enum" required="false">
  </ParamField>
  <ParamField query="promotionIdentifier" param-type="string" required="false">
  </ParamField>
</Expandable>
